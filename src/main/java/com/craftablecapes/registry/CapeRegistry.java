...
public class CapeRegistry {
    ...
    public static final DeferredRegister<Item> ITEMS = 
            DeferredRegister.create(ForgeRegistries.ITEMS, CraftableCapes.MOD_ID);
    
    // ==================== Official Mojang Capes ====================
    public static final RegistryObject<Item> CAPE_OLD_MOJANG;
    public static final RegistryObject<Item> CAPE_MOJANG;
    public static final RegistryObject<Item> CAPE_NEW_MOJANG;
    
    // ==================== Minecon Capes ====================
    public static final RegistryObject<Item> CAPE_MINECON_2011;
    public static final RegistryObject<Item> CAPE_MINECON_2012;
    public static final RegistryObject<Item> CAPE_MINECON_2013;
    public static final RegistryObject<Item> CAPE_MINECON_2015;
    public static final RegistryObject<Item> CAPE_MINECON_2016;
    
    // ==================== Translator Capes ====================
    public static final RegistryObject<Item> CAPE_TRANSLATOR;
    public static final RegistryObject<Item> CAPE_TRANSLATOR_CN;
    public static final RegistryObject<Item> CAPE_TRANSLATOR_JP;
    
    // ==================== Special Event Capes ====================
    public static final RegistryObject<Item> CAPE_MILLIONTH_CUSTOMER;
    public static final RegistryObject<Item> CAPE_DB;
    public static final RegistryObject<Item> CAPE_SNOWMAN;
    public static final RegistryObject<Item> CAPE_SPADE;
    public static final RegistryObject<Item> CAPE_PRISMARINE;
    public static final RegistryObject<Item> CAPE_TURTLE;
    public static final RegistryObject<Item> CAPE_BIRTHDAY;
    public static final RegistryObject<Item> CAPE_SCROLLS;
    public static final RegistryObject<Item> CAPE_COBALT;
    public static final RegistryObject<Item> CAPE_MOJIRA;
    public static final RegistryObject<Item> CAPE_REALMS;
    public static final RegistryObject<Item> CAPE_MIGRATOR;
    public static final RegistryObject<Item> CAPE_VANILLA;
    public static final RegistryObject<Item> CAPE_CHERRY_BLOSSOM;
    public static final RegistryObject<Item> CAPE_15_YEARS;
    public static final RegistryObject<Item> CAPE_MOJANG_OFFICE;
    public static final RegistryObject<Item> CAPE_YEARN;
    public static final RegistryObject<Item> CAPE_HOME;
    public static final RegistryObject<Item> CAPE_MENACE;
    public static final RegistryObject<Item> CAPE_COMMON;
    public static final RegistryObject<Item> CAPE_DOCUMENT;
    public static final RegistryObject<Item> CAPE_ZOMBIE_HORSE;
    public static final RegistryObject<Item> CAPE_MOONLIGHT_TRAIL;
    public static final RegistryObject<Item> CAPE_CRAFTER;
    public static final RegistryObject<Item> CAPE_BUILDER;
    public static final RegistryObject<Item> CAPE_OXEYE;
    public static final RegistryObject<Item> CAPE_COPPER;
    
    // ==================== Local Texture Capes ====================
    public static final RegistryObject<Item> CAPE_TWITCH;
    public static final RegistryObject<Item> CAPE_TIKTOK;
    public static final RegistryObject<Item> CAPE_10_YEARS;
    public static final RegistryObject<Item> CAPE_AWESOM;
    public static final RegistryObject<Item> CAPE_BACON;
    public static final RegistryObject<Item> CAPE_BLONK;
    public static final RegistryObject<Item> CAPE_FROG;
    public static final RegistryObject<Item> CAPE_MCC15;
    public static final RegistryObject<Item> CAPE_MINECON_3;
    public static final RegistryObject<Item> CAPE_MINECON_4;
    public static final RegistryObject<Item> CAPE_MINECON_5;
    public static final RegistryObject<Item> CAPE_NO_CIRCLE;
    public static final RegistryObject<Item> CAPE_NYAN;
    public static final RegistryObject<Item> CAPE_NYE_2011;
    public static final RegistryObject<Item> CAPE_PANCAPE;
    public static final RegistryObject<Item> CAPE_PRIDE;
    public static final RegistryObject<Item> CAPE_SNAIL;
    public static final RegistryObject<Item> CAPE_SQUID;
    public static final RegistryObject<Item> CAPE_VETERINARIAN;
    public static final RegistryObject<Item> CAPE_VILLAGER_RESCUE;
    public static final RegistryObject<Item> CAPE_XBOX;
    public static final RegistryObject<Item> CAPE_XBOX_BDAY;
    public static final RegistryObject<Item> CAPE_XMAS;
    public static final RegistryObject<Item> CAPE_SNIFFER;
    public static final RegistryObject<Item> CAPE_VALENTINE;
    
    // Minecraft Dungeons Capes
    public static final RegistryObject<Item> CAPE_AMETHYST;
    public static final RegistryObject<Item> CAPE_BLUE;
    public static final RegistryObject<Item> CAPE_CLOUDY_CLIMB;
    public static final RegistryObject<Item> CAPE_COW_CRUSADER;
    public static final RegistryObject<Item> CAPE_DOWNPOUR_CAPE;
    public static final RegistryObject<Item> CAPE_FAUNA_FAIRE;
    public static final RegistryObject<Item> CAPE_GLOW;
    public static final RegistryObject<Item> CAPE_HAMMER;
    public static final RegistryObject<Item> CAPE_HERO;
    public static final RegistryObject<Item> CAPE_ICEOLOGER;
    public static final RegistryObject<Item> CAPE_LUMINOUS_NIGHT;
    public static final RegistryObject<Item> CAPE_MYSTERY;
    public static final RegistryObject<Item> CAPE_PHANTOM;
    public static final RegistryObject<Item> CAPE_PRISM_CAPE;
    public static final RegistryObject<Item> CAPE_RED_ROYAL;
    public static final RegistryObject<Item> CAPE_SOUL;
    public static final RegistryObject<Item> CAPE_TURTLE_SHELL;
    public static final RegistryObject<Item> CAPE_YEAR_1;
    public static final RegistryObject<Item> CAPE_YEAR_2;
    
    // Custom Minecon Capes
    public static final RegistryObject<Item> CAPE_MINECON_6;
    public static final RegistryObject<Item> CAPE_MINECON_7;
    public static final RegistryObject<Item> CAPE_MINECON_8;
    public static final RegistryObject<Item> CAPE_MINECON_9;
    public static final RegistryObject<Item> CAPE_MINECON_10;
    public static final RegistryObject<Item> CAPE_MINECON_11;
    public static final RegistryObject<Item> CAPE_MINECON_12;
    public static final RegistryObject<Item> CAPE_MINECON_13;
    public static final RegistryObject<Item> CAPE_MINECON_14;
    public static final RegistryObject<Item> CAPE_MINECON_15;
    public static final RegistryObject<Item> CAPE_MINECON_16;
    public static final RegistryObject<Item> CAPE_4J_STUDIO;
    
    // ==================== Registration ====================
    
    // Helper: register an online cape
    private static RegistryObject<Item> registerOnlineCape(String name, String hash) {
    ...
    private static RegistryObject<Item> registerLocalCape(String name) {
        return ITEMS.register(name + "_cape", () -> {
